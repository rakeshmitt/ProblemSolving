/***
 ...
 that the maximum element of the resulting array is B. If it is not possible,
 then return -1.
...
public class LittlePonnyMaxElement {
    ...
    public static void main(String[] args){
        ...
        arr = (ArrayList<Integer>)Arrays.stream(in).boxed().collect(Collectors.toList());
    ...
    public static int solve(ArrayList<Integer> A, int B) {
        ...
        for(int i=0; i<A.size(); i++){
            ...
            if(A.get(i)==B) foundElement = true;
        }

        if(foundElement) return count;
